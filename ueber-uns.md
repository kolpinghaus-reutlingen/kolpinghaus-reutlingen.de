...
<div class="row">
<div class="col-lg-6">
<a href="{{ site.static.url | append: "w_600,cs_srgb,f_auto,q_auto:good/" | append: "mitarbeiter" }}">
<img class="img-fluid rounded mb-4" src="{{ site.static.url | append: "w_1200,cs_srgb,f_auto,q_auto:best/" | append: "mitarbeiter" }}" alt="Mitarbeiter des Kolpinghauses" />
</a>
</div>
...
<img class="rounded-circle img-fluid d-block mx-auto" width="200" height="200" src="{{ site.static.url | append: "w_200,h_200,cs_srgb,f_auto,q_auto:good/" | append: "rist" }}" alt="Hermann Rist">

### Hermann Rist <small style="font-size: 70%;">Heimleiter</small>
</div>
<div class="col-lg-6 text-center mb-4" markdown="1">
<img class="rounded-circle img-fluid d-block mx-auto" width="200" height="200" src="{{ site.static.url | append: "w_200,h_200,cs_srgb,f_auto,q_auto:good/" | append: "abele" }}" alt="Yvonne Abele">
...
<img class="img-fluid rounded mb-4" style="max-height: 100% !important; width: auto;" src="{{ site.static.url | append: "w_800,cs_srgb,f_auto,q_auto:best/" | append: "adolph-kolping" }}" alt="Adolph Kolping">
</div>
</div>
<br>
<hr>
...
<div class="col">
<img src="{{ site.static.url | append: "cs_srgb,f_auto,q_auto:best/" | append: "kooperationspartner" }}" alt="Kooperationspartner" style="max-width: 100%;">
</div>
{{ site.static.url}}
